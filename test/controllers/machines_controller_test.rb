...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { location: @machine.location, name: @machine.name, picture: @machine.picture } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { location: @machine.location, name: @machine.name, picture: @machine.picture } }
